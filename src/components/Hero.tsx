  ...
  return (
    ...
    >
      <div className="relative z-10 w-full overflow-hidden">
        <div ref={titleRef} className="mb-12 w-full flex flex-col gap-2 sm:gap-3 md:gap-4 font-black uppercase leading-[0.85] text-[6vw] sm:text-[6vw] md:text-[5vw] lg:text-[4.5vw] xl:text-[4vw] drop-shadow-[0_0_15px_rgba(0,0,0,0.3)]">
